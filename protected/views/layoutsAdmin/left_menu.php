<div class="leftmenu">        
    <ul class="nav nav-tabs nav-stacked">
        ...
        <!-- <li><a href="<?php echo CHtml::normalizeUrl(array('/admin/gallery/index')); ?>"><span class="fa fa-image"></span> <?php echo Tt::t('admin', 'Gallery Spotlight') ?></a></li> -->
        ...
        <li class="dropdown"><a href="<?php echo CHtml::normalizeUrl(array('/admin/pdf/index')); ?>"><span class="fa fa-tag"></span> <?php echo Tt::t('admin', 'Investor Report') ?></a>
            <ul>
                <li><a href="<?php echo CHtml::normalizeUrl(array('/admin/pdf/index')); ?>"></a></li>
                <li><a href="<?php echo CHtml::normalizeUrl(array('/admin/pdf/create')); ?>">Add Products</a></li>
                <li><a href="<?php echo CHtml::normalizeUrl(array('/admin/pdf/index')); ?>">Category</a></li>
            </ul>
        </li>
