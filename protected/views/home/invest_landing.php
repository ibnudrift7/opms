<section class="cover-insides hubinvest" style="background-image: url(<?php echo Yii::app()->baseUrl . ImageHelper::thumb(1920, 539, '/images/static/' . $this->setting['invest_hero_image'], array('method' => 'adaptiveResize', 'quality' => '90')) ?>) !important;">
    <div class="begrond">
        <div class="prelative container">
            <div class="teks">
                <div class="row">
                    <div class="col-md-60">
                        <h1 class="teks-cover"><?php echo $this->setting['invest_hero_title'] ?></h1>
                    </div>
                    <div class="col-md-60 ">
                        <div class="teks"><?php echo $this->setting['invest_hero_subtitle'] ?></div>
                    </div>
                </div>
            </div>
        </div>
