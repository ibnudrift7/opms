<section class="cover-insides layanan" style="background-image: url(<?php echo Yii::app()->baseUrl . ImageHelper::thumb(1920, 539, '/images/static/' . $this->setting['service_hero_image'], array('method' => 'adaptiveResize', 'quality' => '90')) ?>) !important;">
    <div class="begrond">
