                ...
                <div class="prelative container sliderrrr">
                    <div class="bxsl_tx_fcs">
                        <div class="row no-gutters">
                            <div class="content col-md-60 text-left">
                                <?php if (Yii::app()->language == 'en') : ?>
                                    ...
                                    <button class="form-control button-red d-inline-block"><a href="<?php echo CHtml::normalizeUrl(array('/home/about', 'lang' => Yii::app()->language)); ?>">Learn More</a></button>
                                    <button class="form-control button-red d-inline-block ml-2"><a target="_blank" href="https://optimapart.com/">Visit our Online Store</a></button>
                                <?php else : ?>
                                    <p class="t1">PT. OPTIMA PRIMA METAL SINERGI</p>
                                    ...
                                    <button class="form-control button-red d-inline-block"><a href="<?php echo CHtml::normalizeUrl(array('/home/about', 'lang' => Yii::app()->language)); ?>">PELAJARI LEBIH LANJUT</a></button>
                                    <button class="form-control button-red d-inline-block ml-2"><a target="_blank" href="https://optimapart.com/">Visit our Online Store</a></button>
                                <?php endif ?>
                            </div>
                        </div>
...
<style>
    @media (min-width: 1990px) {
        .outers_fcs_wrapper .carousel-item {
