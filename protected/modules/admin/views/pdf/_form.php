...
<div class="widgetcontent">
	...
	<div class="row-fluid">
		...
		<?php /*
		<div class="span6">
			<?php echo $form->fileFieldRow($model,'file_en',array(
			'hint'=>'<b>Note:</b> Ukuran tidak boleh melebihi 4MB', 'style'=>"width: 100%")); ?>
			<?php if ($model->scenario == 'update' && $model->file_en !== null): ?>
			<a href="<?php echo Yii::app()->baseUrl ?>/images/pdf/<?php echo $model->file_en ?>">Lihat file di sini</a>
			<?php endif; ?>
		</div>
		*/ ?>
	</div>
