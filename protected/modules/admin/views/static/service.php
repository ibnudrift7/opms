	...
	<div class="span8">
		<div class="widget">
			...
			<div class="widgetcontent">
				...
				<p class="help-block">NOTE: Picture landscape with min size 1920 x 539 px, Larger image will be automatically cropped.</p>
				...
				<?php $type = 'service_hero_subtitle' ?>
		...
		<div class="widgetbox">
			...
			<div class="widgetcontent">
				<div class="row-fluid">
					...
					<div class="span6">
						<?php $type = 'service1_image1' ?>
						<?php Common::createSetting($type, 'Picture Banner', 'image', 'n') ?>
						<label for="Setting_<?php echo $model[$type]['data']->name ?>" class="control-label required"><?php echo $model[$type]['data']->label ?><span class="required"></span></label>
						<?php echo CHtml::fileField('Setting[' . $model[$type]['data']->name . ']', $model[$type]['data']->value, array('class' => 'span12')) ?>
						<p class="help-block">NOTE: Picture landscape width 683 x 566px.</p>
						<?php if ($model[$type]['data']->value) : ?>
							<div style="">
