...
class HomeController extends Controller
{
	...
	public function actionProductDef()
	{
		$this->layout = '//layouts/column2';
		$this->pageTitle = 'Product - ' . $this->pageTitle;

		$this->render('productdef', array());
	}

	public function actionProductRound()
	{
		$this->layout = '//layouts/column2';
		$this->pageTitle = 'Product - ' . $this->pageTitle;

		$this->render('productround', array());
	}

	public function actionProductSquare()
	{
		$this->layout = '//layouts/column2';
		$this->pageTitle = 'Product - ' . $this->pageTitle;

		$this->render('productsquare', array());
	}
	...
	{
		$this->layout = '//layouts/column2';
		$this->pageTitle = 'Project - ' . $this->pageTitle;
	...
	public function actionHubinvest()
	{
		$this->pageTitle = 'Hubungan Investor - ' . $this->pageTitle;
		$this->layout = '//layouts/column2';

		$this->render('hubinvest', array());
	}
	...
	public function actionHubungi()
	{
		...
		if (isset($_POST['ContactForm'])) {
			...
			if ($status and $model->validate()) {
				...
				$config = array(
					'to' => array($model->email, 'inquiry@opms.co.id'),
				...
				if ($this->setting['contact_bcc']) {
					$config['bcc'] = array('ibnudrift@gmail.com');
				}
...
');
	...
	public function actionCareer()
	{
		...
		$model = CareerList::model()->findAll();

		$this->render('//home/career', array(
			'model' => $model,
		));
	}
